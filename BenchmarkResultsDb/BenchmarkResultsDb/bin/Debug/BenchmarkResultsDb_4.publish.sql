...
GO
PRINT N'Rename refactoring operation with key 58d0fabe-9622-438e-a556-6aee87d4f013 is skipped, element [dbo].[scheduled_adhoc_runs] (SqlTable) will not be renamed to adhoc_run_configs';
...
GO
ALTER TABLE [dbo].[tracing_logs] WITH NOCHECK
